...
-- Version: 4.2 - Keep parameters as variable references for complex instructions
-- Author: minisparrow
-- Date: 2025-11-18
...
local function value_to_string(val, depth)
  ...
  elseif val.op == "extractvalue" then
    -- Keep aggregate parameter as variable reference
