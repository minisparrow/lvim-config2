...
-- Version: 3.2 - Fixed getelementptr parsing and insertvalue display
-- Author: minisparrow
-- Date: 2025-11-13
...
function M.setup()
  ...
  vim.notify("🎯 LLVM Simplifier v3.2 loaded! (by @minisparrow)\n" ..
    "  <leader>ld or :LLVMDeps - Show dependency tree\n" ..
    "  :LLVMDebug - Toggle debug mode\n" ..
    "  Fixed: getelementptr parsing, circular reference detection\n" ..
